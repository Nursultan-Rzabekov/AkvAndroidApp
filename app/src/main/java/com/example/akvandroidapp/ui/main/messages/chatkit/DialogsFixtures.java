...
public final class DialogsFixtures extends FixturesData {
    ...
    public static ArrayList<UserDialogMessages> getDialogs() {
        ArrayList<UserDialogMessages> chats = new ArrayList<>();
    ...
    private static UserDialogMessages getDialog(int i, Date lastMessageCreatedAt) {
        ArrayList<User> users = getUsers();
        return new UserDialogMessages(
                getRandomId(),
