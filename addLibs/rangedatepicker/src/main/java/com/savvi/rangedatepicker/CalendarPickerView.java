...
public class CalendarPickerView extends RecyclerView {
    ...
    public FluentInitializer init(Date minDate, Date maxDate) {
        ...
        return init(minDate, maxDate, TimeZone.getDefault(), Locale.getDefault(), sdf);
    }


    public FluentInitializer init(Date minDate, Date maxDate, TimeZone timeZone) {
        return init(minDate, maxDate, timeZone, Locale.getDefault(), new SimpleDateFormat("MMMM, yyyy", Locale.getDefault()));
    }
    ...
    public FluentInitializer init(Date minDate, Date maxDate, Locale locale) {
        return init(minDate, maxDate, TimeZone.getDefault(), locale, new SimpleDateFormat("MMMM, yyyy", locale));
    }
